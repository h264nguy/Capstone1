...
from app.core.status import get_live_status
...
from app.routers.status_page_routes import router as status_page_router


def create_app() -> FastAPI:
    app = FastAPI(title="Smart Bartender API", docs_url="/docs", redoc_url="/redoc")
